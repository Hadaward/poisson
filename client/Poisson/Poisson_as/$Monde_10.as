package 
{
	...
	public dynamic class $Monde_10 extends flash.display.MovieClip
	{
		...
		public function Initialisation_Sol(ListeMobile:flash.display.MovieClip):void {
			...
			this._root.MondePhysique.CreateBody(BodyDef).CreateShape(this._root.Mobile_Statique(UserData, new Array(0, 400, 0, 50, 50, 50, 50, 400)));
		}
	}
}
